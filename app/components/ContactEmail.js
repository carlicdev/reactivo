...
export function ContactEmail({url, name}) {
    return (
        <Html lang='en'>
            <Tailwind>
                <Body className="bg-slate-100 my-auto mx-auto font-sans">
                    <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] w-[465px]">
                        <Section className="mt-[32px]">
                            <Img
                                src={`${baseUrl}/public/reactivoImg.png`}
                                width="40"
                                height="37"
                                alt="reactivo"
                        ...
                        <Text className="text-black text-[14px] leading-[24px]">
                           Hemos recibido tu mensaje. Nuestros expertos se pondrán en contacto contigo lo más pronto posible. 
                        </Text>
                        <Text className="text-black text-[14px] leading-[24px]">
