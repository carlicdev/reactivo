    ...
    <div className='max-w-7xl mx-auto w-full pt-10 md:pt-24 px-10 lg:px-0'>
        ...
        <div className='mb-[100px] mt-[50px]'>
            ...
            <div className='flex flex-wrap items-center pt-20 px-6 my-[100px]'>
                ...
                <div className='w-full mt-5 lg:mt-0 lg:w-1/2 lg:pl-24 pb-8 '>
            ...
            <div className='flex flex-wrap items-center pt-20 px-6 my-[100px]'>
                ...
                <div className='lg:order-1 w-full mt-5 lg:mt-0 lg:w-1/2 lg:pr-24 pb-8 '>
            ...
            <div className='flex flex-wrap items-center pt-20 px-6 my-[100px]'>
                ...
                <div className='mt-5 lg:mt-0w-full lg:w-1/2 lg:pl-24 pb-8 '>
